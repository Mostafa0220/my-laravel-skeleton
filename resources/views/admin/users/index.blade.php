    ...
    <div class="container">
        <form action="{{ route('admin.users.import') }}" id="import-form" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4"><a class="btn btn-outline-warning"
                                         href="{!! route('admin.users.export', ['type' => 'xlsx']) !!}"><i
                            class='icon ion-upload'></i> Export </a></div>
                <div class="col-md-4"><a href="{{ route('admin.users.create') }}" class="btn btn-outline-primary "> <i
